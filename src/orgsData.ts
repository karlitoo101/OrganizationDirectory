...
export const ORGANIZATIONS: Organization[] = [
  {
    ...
    openFor: 'ALL',
    campus: 'All Campuses',
    description: 'A global community of student cloud enthusiasts focused on AWS cloud technologies, hosting technical workshops, hands-on labs, and fostering cloud innovation and cloud architecture competencies.',
  ...
  {
    id: 'jpcs-qcu',
    name: 'Junior Philippine Computer Society - QCU',
    acronym: 'JPCS',
  ...
  },
  {
    ...
    name: 'Creatives Student Society',
    acronym: 'CSS',
    category: 'University-Wide Organizations',
    type: 'Leadership',
    fields: ['Cultural & Humanities', 'Public Service', 'Arts & Creatives', 'Journalism'],
  ...
  },
  {
    ...
    openFor: '',
    campus: 'All Campuses',
    description: 'The supreme academic community for Bachelor of Secondary Education majors, refining pedagogical methodologies, speech coaching, demonstration mock classes, and public teaching drives.',
  ...
  },
  {
    ...
    openFor: '',
    campus: 'All Campuses',
    description: 'Promoting local heritage preservation, Filipino folk arts appreciation, and holding cultural exhibitions that connect our contemporary student identity with historical QC legacies.',
...
// Force join fee to always be Free, clear mission & vision, empty non-AWS officers, requirements, and featured events
ORGANIZATIONS.forEach((org) => {
  org.membershipFee = 'Free';
  org.mission = '';
  org.vision = '';
  
  if (org.id !== 'aws-cloud-club') {
    org.officers = [];
  }
