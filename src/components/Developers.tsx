...
export default function Developers() {
  const devs = [
    {
      ...
      links: [
        {
          label: "Karl Jhon Mangapot | LinkedIn",
          url: "https://www.linkedin.com/in/karl-mangapot/",
        },
        {
          label: "Karl Jhon Mangapot | Portfolio",
          url: "https://karlmangapot.tech/",
        },
      ],
    ...
    },
    {
      ...
      links: [
        {
          label: "Rochele Fernandez | LinkedIn",
          url: "https://www.linkedin.com/in/rochele-fernandez-7a8964354/?skipRedirect=true",
        },
        {
          label: "Rochele Fernandez | Portfolio",
          url: "https://about-rclfern.vercel.app/",
        },
      ],
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8 animate-in fade-in duration-300">
      ...
      <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-white p-6 md:p-10 shadow-xs mb-10">
        ...
        <div>
          ...
          <p className="text-slate-650 text-xs md:text-sm leading-relaxed mb-4">
            Taking the initiative to empower the QCU student community,{" "}
            <strong>Rochele and Karl</strong> built a dedicated web platform for
          ...
          <div className="flex flex-wrap gap-4 text-xs font-bold text-slate-400 uppercase tracking-wider pr-6">
            <div className="flex items-center gap-1.5">
              ...
              <span>AWS Student Builder Group - QCU</span>
            </div>
            <div className="flex items-center gap-1.5">
              <Rocket className="h-4 w-4 text-indigo-600" />
              <span>Developer Camp - QCU</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-6 block font-mono">
          ...
          >
            <div>
              ...
              <div className="flex items-center gap-4">
                <div
                  className={`w-14 h-14 shrink-0 rounded-2xl flex items-center justify-center font-black text-lg shadow-sm border border-slate-100 ${dev.avatarBg}`}
                >
                  {dev.initials}
                </div>
                <div>
            ...
            <div className="mt-6 pt-4 border-t border-slate-100">
              <div className="flex flex-wrap gap-1 mb-4">
                {dev.skills.map((s) => (
                  <span
                    key={s}
                    className="bg-slate-150 px-1.5 py-0.5 rounded text-[8px] font-bold text-slate-650 border border-slate-200/50"
                  >
                    {s}
                  </span>
                ))}
